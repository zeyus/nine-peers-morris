...
<div class="space-y-3">
    {#if peers.length === 0}
        <div class="text-center py-8">
            ...
            <p class="text-gray-500 dark:text-gray-400 font-medium">No other players online</p>
            <p class="text-sm text-gray-400 dark:text-gray-500 mt-1">Share your Peer ID with friends to play together!</p>
        </div>
    {:else}
