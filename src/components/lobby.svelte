        ...
        {#if p && $peerConfig.pId}
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-6">
                <div class="text-center mb-6">
                    <h1 class="text-3xl font-bold text-gray-800 dark:text-gray-100 mb-2">Nine Men's Morris</h1>
                ...
                <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 mb-6">
                    <div class="flex items-center justify-center space-x-2">
                        ...
                        <span class="font-mono text-lg font-semibold text-indigo-600 dark:text-indigo-400 bg-white dark:bg-gray-800 px-3 py-1 rounded border border-gray-200 dark:border-gray-600">
                            {$peerConfig.pId}
                        </span>
                    </div>
                </div>
                ...
                {#if them}
                    <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 rounded-lg p-4 mb-6">
                        <div class="flex items-center justify-center space-x-2">
                            <div class="w-3 h-3 bg-green-500 dark:bg-green-400 rounded-full animate-pulse"></div>
                            <span class="text-green-800 dark:text-green-300 font-medium">Connected to {them}</span>
                        </div>
                    </div>
                {/if}
                ...
                <Modal headerClass="dark:text-white" title="Game Invitation" bind:open={modalVisible} onclose={() => modalVisible = false} dismissable={false}>
                    <div class="text-center p-6">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Game Request!</h3>
                ...
                <div class="text-center">
                    {#if supported === false}
                        <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 rounded-lg p-6">
                            ...
                            <h3 class="text-lg font-semibold text-red-800 dark:text-red-300 mb-2">Browser Not Supported</h3>
                            <p class="text-red-600 dark:text-red-400">Sorry, your browser does not support WebRTC which is required for peer-to-peer gaming.</p>
                        </div>
                    {:else}
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
                            <Spinner size="8" color="blue" />
                            <p class="text-gray-600 dark:text-gray-400 mt-4">Connecting to lobby...</p>
                        </div>
                    {/if}
                </div>
            </div>
